...
def player_input(player) :
    ...
    while True:
        usr_turn = input(f"Player '{player}', enter a ROW and a COLUMN between 1 and 3(e.g. '1 2'): ")
...
def check_win() -> bool:
    ...
    col_win = field[real_turn[0]][real_turn[1]] == field[(real_turn[0] + 1) % 3][(real_turn[1]) % 3] == field[(real_turn[0] + 2) % 3][(real_turn[1]) % 3]
    row_win = field[real_turn[0]][real_turn[1]] == field[(real_turn[0]) % 3][(real_turn[1] + 1) % 3] == field[(real_turn[0]) % 3][(real_turn[1] + 2) % 3]
