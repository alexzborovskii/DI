...
-- SELECT first_name, last_name, number_oscars FROM actors order by number_oscars;
-- select * from actors where age > '1/01/1970';
-- select * from actors where first_name in('David', 'Morgan', 'Will')
-- select number_oscars, count(first_name) from actors group by number_oscars;
